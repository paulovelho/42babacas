...
class ChapolinSinceroService {
  ...
  public static function NormalizeTweet($tweet) {
    $tweet = self::UncapitalizeIt($tweet);
    $tweet = self::RemoveEntities($tweet);
    return $tweet;
  }
  ...
  public static function GetWords($tweet){
    $text = self::CleanTweetForAnalysis($tweet);
  ...
  public static function RemovePlurals($text) {
    return preg_replace("/s\b/", "", $text);
  }

  public static function CleanTweetForAnalysis($text) {
    $text = self::RemoveAccents($text);
    $text = self::RemovePunctuation($text);
    $text = strtolower($text);
    $text = self::RemovePlurals($text);
    return $text;
  }
